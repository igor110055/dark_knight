...
def test_buy_natural_sell_synthetic__cannot_book_the_first_limit_order__fail_the_arbitrage(
    ...
    assert not service.buy_natural_sell_synthetic(
        symbol, synthetic, None, None, {"asks": "43.5"}
    )
...
def test_buy_natural_sell_synthetic__can_book_the_first_limit_order__success(service):
    ...
    assert service.buy_natural_sell_synthetic(
        symbol, synthetic, None, None, {"asks": "55"}
    )
