...
def get_triangulars(symbols=None):
    ...
    for symbol, [base_asset, quote_asset] in symbols.items():
        G.add_edge(
            base_asset, quote_asset, assets=(base_asset, quote_asset), symbol=symbol
        )
...
def get_synthetic(G, natural_base_currency, natural_quote_currency, path):
    ...
    left_normal = (
        left_base_currency == natural_base_currency
        or left_quote_currency == natural_quote_currency
    )
    ...
    right_normal = (
        right_base_currency == natural_base_currency
        or right_quote_currency == natural_quote_currency
    )
